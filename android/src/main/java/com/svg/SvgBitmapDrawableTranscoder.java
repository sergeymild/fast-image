...
import com.svg.utils.BitmapProvider;
import com.svg.utils.SvgUtils;

@RestrictTo(RestrictTo.Scope.LIBRARY)
public final class SvgBitmapDrawableTranscoder implements ResourceTranscoder<SVG, BitmapDrawable> {

    private final BitmapPool mBitmapPool;
    private final Resources mResources;
    private final BitmapProvider mBitmapProvider;

    public SvgBitmapDrawableTranscoder(@NonNull Context context, @NonNull Glide glide) {
